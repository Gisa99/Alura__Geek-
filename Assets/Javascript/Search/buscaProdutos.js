...
async function listaItens(){
    const produto = await conectaApi.listaItens();
    produto.forEach(elemento => renderiza.appendChild(
        renderizaItens( elemento.imageURL, elemento.name,  elemento.price)))
}
        ...
        inputPesquisaMobile.addEventListener("input", async (evento) => {
            ...
            try {
                ...
                if (Array.isArray(busca)) {
                    ...
                    busca.forEach(elemento => renderiza.appendChild(renderizaItens(elemento.imageURL, elemento.name, elemento.price)));
                    listaItens()
                } else {
